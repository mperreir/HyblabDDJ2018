...
$(document).ready(function() {
        ...
        $.post( "http://hyblab.polytech.univ-nantes.fr:8080/nantes-st-nazaire-dev/rangs")
            .done(function(data) {
    ...
    var jqxhr = $.post( "http://hyblab.polytech.univ-nantes.fr:8080/nantes-st-nazaire-dev/actifs")
        .done(function(data) {
            console.log( "success" );
            console.log(data)
