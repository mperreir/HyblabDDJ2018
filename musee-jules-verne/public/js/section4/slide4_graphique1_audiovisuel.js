var ctx = document.getElementById('slide4_graphique1_audiovisuel');

var slide4_graphique1_audiovisuel = new Chart(ctx, {
  type: 'line',
  data: {
    ...
    datasets: [
      {
        ...
        data: [92,72,22,350,370,365,295,197,291,317,171],
        borderColor: '#0972ff',
        lineTension: 0.3,
        pointColor: '#0972ff',
        pointRadius: 4,
