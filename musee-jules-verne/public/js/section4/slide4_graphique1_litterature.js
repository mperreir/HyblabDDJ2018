...
var ctx = document.getElementById('slide4_graphique1_litterature');

var slide4_graphique1_litterature = new Chart(ctx, {
  type: 'line',
  data: {
    ...
    datasets: [
      {
        ...
        data: [164,101,32,440,370,921,722,1045,574,823,369],
        borderColor: '#0972ff',
        lineTension: 0.3,
        pointColor: '#0972ff',
        pointRadius: 4,
