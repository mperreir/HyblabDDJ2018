//===== SUJET = DIVERS — Graphique 1 de la slide 4


var ctx = document.getElementById('slide4_graphique1_divers');

var slide4_graphique1_divers = new Chart(ctx, {
  type: 'line',
  data: {
    ...
    datasets: [
      {
        ...
        data: [126,121,42,346,417,598,832,1352,975,1170,304],
        borderColor: '#0972ff',
        lineTension: 0.3,
        pointColor: '#0972ff',
        pointRadius: 4,
...
//===== FIN SUJET = DIVERS — Graphique 1 de la slide 4
